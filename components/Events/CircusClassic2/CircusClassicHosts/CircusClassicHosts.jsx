...
import UiAvatar from '/components/Ui/UiAvatar/UiAvatar';
    ...
    <>
      ...
      <div className={styles.hosts}>
        ...
        <div className={styles.host}>
          <UiAvatar
            imgUrl={
              'https://res.cloudinary.com/ionpetro/image/upload/v1662221194/production/assets/225754388_10226658535592157_172022301914930651_n_dpd8cs.jpg'
            }
            size={'large'}
          />
          <span className={styles.hostName}>Socrates Rizos</span>
          <a
            href={'https://www.instagram.com/iamsocratesrizos/'}
            target={'_blank'}
            rel={'noreferrer'}
          >
            <Instagram className={styles.svg} />
